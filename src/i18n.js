...
const STRINGS = {
  'pt-BR': {
    ...
    navShows: 'shows',
    navContact: 'contato',
    heroTagline: 'músico • baixista • guitarrista • baterista • produtor',
    ...
    aboutBio1:
      'Francisco Chico é músico, baixista, guitarrista, baterista, produtor e criador de conteúdo, com base em [localização].',
    aboutBio2:
    ...
    footerCopyright: '© {year} Francisco Chico',
    ariaLangSwitch: 'Idioma do site',
    ariaCursorPick: 'Estilo do cursor do mouse',
    cursorWin95: 'Cursor em estilo Windows 95',
    ...
    musicTitleBar: 'Francisco Chico — player',
    musicClose: 'Fechar',
    ...
    musicFooterArtist: 'Francisco Chico',
  ...
  'en-US': {
    ...
    navShows: 'shows',
    navContact: 'contact',
    heroTagline: 'musician • bassist • guitarist • drummer • producer',
    ...
    cursorWin95: 'Windows 95 arrow cursor',
    ...
    musicTitleBar: 'Francisco Chico music player',
    musicClose: 'Close',
